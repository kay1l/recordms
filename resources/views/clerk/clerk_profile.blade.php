            ...
            <div class="col-lg-3 col-md-4">
                <div class="ibox">
                    <div class="ibox-body text-center">
                        ...
                        <h5 class="font-strong m-b-10 m-t-10">{{ $clerkData->name }}</h5>
                        <div class="m-b-20 text-muted">{{ $clerkData->role }}
                            <h6 class="text-muted m-b-10 m-t-10">{{ $clerkData->college->collegeName ?? null }}</h6>
                        </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" name="name" type="text"
                                                            placeholder="" value="{{ $clerkData->name }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
