...
@section('content')
    ...
    <div class="col-xl-12">
        <div class="ibox">
            <div class="ibox-head">
                <div class="ibox-title">Year: {{ $selectedYear }} <br> College: {{ $selectedCollegeName }} <br> Department:
                    {{ $selectedProgramName }}
                </div>
                <div class="form-group-sm text-right">
                    <a href="{{ route('accomplishment.pdf', ['year' => $selectedYear]) }}" target="_blank"
                        class="btn btn-primary btn-rounded" title="Generate Report for this Activity">
                        ...
                        <tbody>
                            @foreach ($activities as $activity)
                                <tr>
                                    ...
                                    <td><span
                                            class="badge badge-default m-r-5 m-b-5">{{ $activity->start->format('Y-m-d') }}</span>
                                    </td>
                                    <td><span
                                            class="badge badge-default m-r-5 m-b-5">{{ $activity->end->format('Y-m-d') }}</span>
                                    </td>
                                    ...
                                    @endif
                                                     ...
                                                     <td>
                                                        ...
                                                        <span class="file-name" id="moa-file-name-{{ $activity->activity_code }}">
                                                            ...
                                                            <a href="javascript:void(0);" class="text-center align-middle text-danger m-l-5 btn-clear"  title="Remove this File"
                                                                    data-activity-code="{{ $activity->activity_code }}" data-file-type="moa" style="font-size: 1.5em;" >
                                                                    &times;
                                                                </a>
                                                                <a href="{{ route('file.download.uhead', ['filePath' => base64_encode($activity->moa_uploaded)]) }}"
                                                                    target="_blank" >
                                        ...
                                        {{ $activity->proposal_uploaded ? 'd-none' : 'btn-info' }}"
                                            ...
                                            <span class="file-name" id="proposal-file-name-{{ $activity->activity_code }}">
                                                ...
                                                &times; 
                                                    ...
                                                    <a href="{{ route('file.download.uhead', ['filePath' => base64_encode($activity->proposal_uploaded)]) }}"
                                                        target="_blank">
                                    ...
                                    {{ $activity->terminal_uploaded ? 'd-none' : 'btn-info' }}"
                                            ...
                                            <span class="file-name" id="terminal-file-name-{{ $activity->activity_code }}">
                                                ...
                                                &times;
                                                    ...
                                                    <a href="{{ route('file.download.uhead', ['filePath' => base64_encode($activity->terminal_uploaded)]) }}"
                                                        target="_blank">
                                    ...
                                    <td>
                                        @if ($activity->terminal_uploaded)
                                            <button type="button"
                                                class="btn m-r-5 btn-upload 
                                    {{ $activity->attendance_uploaded ? 'd-none' : 'btn-info' }}"
                                                data-toggle="modal" data-target="#uploadModal"
                                                data-activity-code="{{ $activity->activity_code }}"
                                            ...
                                            <span class="file-name"
                                                ...
                                                &times;
                                                    ...
                                                    <a href="{{ route('file.download.uhead', ['filePath' => base64_encode($activity->attendance_uploaded)]) }}"
                                                        target="_blank">
                                    ...
                                    {{ $activity->evaluation_uploaded ? 'd-none' : 'btn-info' }}"
                                            ...
                                            <span class="file-name"
                                                ...
                                                &times;
                                                    ...
                                                    <a href="{{ route('file.download.uhead', ['filePath' => base64_encode($activity->evaluation_uploaded)]) }}"
                                                        target="_blank">
                                    ...
                                    <td class="text-center align-middle">
                                        <a href="{{ route('downloadPdf', ['activityCode' => $activity->activity_code]) }}"
                                            class="">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function fetchProgress(activityCode) {
                $.ajax({
                    url: '{{ url('/get-activities-progress-uhead') }}/' + activityCode,
                    type: 'GET',
            ...
            $('#uploadModal').on('show.bs.modal', function(event) {
                ...
                $('#modal-upload-form').attr('action', '{{ url('/uploadFileUnithead') }}/' + activityCode);
            });
