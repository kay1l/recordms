...
@section('content')
    ...
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Activities Matrix</li>
        </ol>
    </nav>
    <div class="container">
        <div class="ibox ibox-success">
            ...
            @foreach ($college as $college)
                <form action="{{ route('matrixResult.unithead', ['collegeCode' => $college->collegeCode ]) }}" method="get"
                    class="form-inline">
                    @csrf
                    <div class="form-group-sm mr-3">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control" type="text" id="year" name="year" placeholder=""
                                title="Select Year" style="width: 100px;">
                        </div>
                    </div>

                    <div class="form-group-sm mr-3">
                        <label for="collegeCode"><b>Select College</b></label>
                        <div class="input-group">
        ...
        document.addEventListener('DOMContentLoaded', function(){
            $(document).ready(function() {
                        $('#collegeCode').change(function() {
                            ...
                            if (collegeCode) {
                                $.ajax({
                                    url: '/getProponentsunithead/' + collegeCode,
                                    type: 'GET',
                                    dataType: 'json',
